...
public class OpenBankCommand extends NonTerminatingCommand {
	private final CentralBank centralBank;

	public OpenBankCommand(UserInterface userInterface, CentralBank centralBank) {
		super(userInterface);
	...
	public void run() {
		...
		getUserInterface().writeReturnedValue(
				"New bank",
				centralBank.openBank(bankName, bankModel)
		);
	}
}
